...
function startAnnotationProcess() {
    ...
    createCSSClass(".highlight_element_light", "outline: dashed 1px #ff28009c; border-radius: 0.4rem; padding: 0.4rem; cursor: crosshair;")
    createCSSClass(".highlight_element_strong", "outline: solid 1px #ff28009c; border-radius: 0.4rem; padding: 0.4rem; cursor: crosshair;")
    ...
    document.body.addEventListener("click", (e) => {
        ...
        if(e.ctrlKey) {
            ...
            if(t.classList.contains("highlight_element_strong")) {
                ...
                if(editAnnotationModal) {
                    removeHTMLElement(editAnnotationModal);
                }
...
const EDIT_ANNOTATION_MODAL = (curAnnotation) => {
    const markup = `
